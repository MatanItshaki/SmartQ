...
export default function OwnerAppointmentsPanel() {
    ...
    const fetchAppointments = async () => {
        try {
            ...
            const res = await ownerAPI.getAppointments(params);
        ...
        <Box>
            ...
            <Box sx={{ mb: 4 }}>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                    View and manage all appointments for your business.
                </Typography>
            </Box>
                                ...
                                return (
                                    <TableRow key={a._id} sx={{ '&:hover': { background: 'rgba(255,255,255,0.03)' }, '& td': { borderBottomColor: 'rgba(255,255,255,0.05)' } }}>
                                        ...
                                        <TableCell>
                                            ...
                                            <Typography variant="caption" sx={{ color: 'text.secondary' }}>{a.client?.phone || a.client?.email || ''}</Typography>
                                        </TableCell>
                                        <TableCell sx={{ color: 'text.secondary' }}>{a.employee?.name || '—'}</TableCell>
                                        <TableCell>
                                            <Typography sx={{ fontWeight: 500 }}>{a.service?.name || '—'}</Typography>
                                            {a.service?.price && (
                                                <Typography variant="caption" sx={{ color: '#14b8a6' }}>₪{a.service.price}</Typography>
                                            )}
                                        </TableCell>
                                        <TableCell>
                                            <Chip
